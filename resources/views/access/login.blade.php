<div class="font-sans text-gray-900 antialiased">
    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        ...
        <form method="POST" action="http://localhost:1234/login">
            <input type="hidden" name="_token" value="ns8OdJVcmHCM3s6oFlWivaEHjsb7MKWtGF37aqNo">
            <!-- Email Address -->
            <div>
    ...
    Password
            ...
            <div class="flex items-center justify-end mt-4">
                                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="http://localhost:1234/forgot-password">
